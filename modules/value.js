import sborka, { summAll } from "./calculate.js";
...
document
  ...
  .addEventListener("click", showValues);
...
document
  .querySelector('[category="second"]')
  .addEventListener("click", showValuesWithArmor);
...
document
  .querySelector('[category="third"]')
  .addEventListener("click", timeToKill);
...
document
  ...
  .forEach((item) => item.addEventListener("click", setCategory));
