...
document.querySelectorAll('.art-label .art').forEach((item => item.addEventListener('click', artBlocks)))
...
document.querySelectorAll('.art-label .dop').forEach((item => item.addEventListener('click', dopBlocks)))
...
document.querySelectorAll('.close').forEach((item => {item.addEventListener('click', hide)}))